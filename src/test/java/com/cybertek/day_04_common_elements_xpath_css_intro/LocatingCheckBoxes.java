...
public class LocatingCheckBoxes {
    ...
    public static void main(String[] args) {
        ...
        // we can use additional called isSelected() to determine if it's checked
        ...
        checkbox2.click(); // currently, it's checked so clicking will check it

        //check if it's already checked then click on it
