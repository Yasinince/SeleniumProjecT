...
public class ActionsClassTest extends TestBase {
    ...
    public void testKeyboardAction(){
        ...
        //hold down to shift enter "i love selenium"
        //release the shift
        //enter text "i love selenium"
        //hold down to ctrl and enter "A"
        ...
        //SendKeys method of Action class is for pressing key that provided
        // pause method of Actions class is for pausing in between actions in milliseconds



        //this is way way way way more than enough to demonstrate you can take any keyboard action
        actions.keyDown(Keys.SHIFT)
                .sendKeys("i love selenium").pause(2000).
                keyUp(Keys.SHIFT)
                .sendKeys("i love selenium").pause(2000)
                .keyDown(Keys.CONTROL).sendKeys("A")// Control+a on will select all text
